						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-aboutus tg-visionmission">
									<figure><img src="../images/courses/sundazhi.jpg" alt="image description"></figure>
									<h3>个人简介</h3>
									<p> 最高学位：博士<br>
										邮箱：sundazhi@tju.edu.cn<br>
										通讯地址：北洋园校区55楼B407<br>
										个人主页：http://cs.tju.edu.cn/faculty/sundazhi/<br>
										</p>
									<h3>研究方向</h3>
									<p>信息与网络安全、可信问题、应用密码学</p>
									<h3>学术论文</h3>
									<p> [1] Da-Zhi Sun and Xiao-Hong Li, Vulnerability and enhancement on Bluetooth pairing and link key generation scheme for Security Modes 2 and 3, in: Kwok-Yan Lam and Chi-Hung Chi (Eds), Proceedings of the 18th International Conference on Information and Communications Security-ICICS 2016, LNCS 9977, Springer-Verlag, 2016, pp. 403-417.<br>
										[2] Da-Zhi Sun and Ji-Dong Zhong, Cryptanalysis of a hash based mutual RFID tag authentication protocol, Wireless Personal Communications 91(3) (2016) 1085-1093.<br>
										[3] Zhong-Yuan Hao, Wei Guo, Ji-Zeng Wei, and Da-Zhi Sun, Dual processing engine architecture to speed up optimal Ate pairing on FPGA platform, to appear in Proceedings of the 15th IEEE International Conference on Trust, Security and Privacy in Computing and Communications-TrustCom 2016, IEEE, 2016.<br>
										[4] Da-Zhi Sun, Zahra Ahmadian, Yue-Jiao Wang, Mahmoud Salmasizadeh, and Mohammad Reza Aref, Analysis and enhancement of desynchronization attack on an ultralightweight RFID authentication protocol, Cryptology ePrint Archive, Report 2015/037 (2015).<br>
										[5] Shao-Guang Geng, Xiao-Hong Li, Zhi-Yong Feng, and Da-Zhi Sun, Web application architecture security evaluation method based on AADL, in: Proceedings of the 20th International Conference on Engineering of Complex Computer Systems-ICECCS 2015, IEEE, 2015, pp. 186-189.<br>
										</p>
										<h3>专利申请</h3>
									<p> [1] 孙达志，孙济洲，张加万，一种抵抗简单电耗攻击的点乘计算方法, 受理号：200810154231.2, 授权号：ZL 2008 1 0154231.2.<br>
										[2] 孙达志，王月娇，冯志勇，无线传感网络中基于密码hash计算的一种有效认证方法，受理号：201210578596.4, 授权号：ZL 2012 1 0578596.4.<br>
										[3] 孙达志，王月娇，李晓红，RFID系统中基于HB+的一种强安全认证方法，受理号：201210185839.8, 授权号：ZL 2012 1 0185839.8.<br>
										[4] 孙达志，毛雅佼，李晓红，许光全，RFID系统中有效转移标签所有权的方法，受理号：201410068882.5, 授权号：ZL 2014 1 0068882.5.<br>
										[5] 孙达志，杨博为，李晓红，改进的滑动窗口模幂计算方法，受理号：201410726861.8.<br>
										[6] 孙达志，朱泽光，李晓红，许光全，一种适用于实时数据库的安全并发控制方法，受理号：201510264204.0.<br>
									</p>
								</div>
							</div>
						</div>
