						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-aboutus tg-visionmission">
									<figure><img src="../images/courses/yumei.jpg" alt="image description"></figure>
									<h3>个人简介</h3>
									<p> 天津大学ACM代表队教练，带领天津大学ACM代表队在亚洲区比赛中取得了优异的成绩，获得了多个奖项，并两次率领天津大学ACM代表队进入世界总决赛。<br>
									担任天津大学IT学科创新创业训练基地指导教师，负责基地建设。<br><br>
									最高学位：博士<br>
									邮箱：yueyouyueyou@gmail.com<br>
									通讯地址：天津大学北洋园校区55-B525<br>
									研究方向：计算机网络、数据库、数据挖掘<br>
									个人主页：<a href="http://cs.tju.edu.cn/faculty/yumei/yumei.jsp">http://cs.tju.edu.cn/faculty/yumei/</a></p>
									<h3>研究方向</h3>
									<p>计算机网络、数据库、数据挖掘</p>
									<h3>研究内容：</h3>
									<p>基于DNS的不良网站过滤算法研究<br>
									社交网络中用户关系和用户行为分析<br>
									社交网络中实体社团的发现及识别、影响因素及发展规律研究 <br>
									社交网络中的情感分析、用户建模、推荐算法研究 <br>
									在线社会网络、移动社会网络的资源搜索、信誉机制 <br>
									网络排名算法优化机制研究 
									</p>
								</div>
							</div>
