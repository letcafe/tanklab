                                ...
                                <table id="fileListView" class="table table-hover">
                                    ...
                                    <c:forEach items="${pagedAnnouncement}" var="announcement">
                                        <tr>
                                            ...
                                            <td class="col-xs-1" style="border-right: 0;border-left: 0;border-top: 0"><button class="label"><a href="/tanklab/detailAnnouncement?id=${announcement.id}">详情</a></button></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
