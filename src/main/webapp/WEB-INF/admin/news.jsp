...
<div class="wrapper">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div id="mainTable" class="box-body">
                            ...
                            <table id="newsTable" data-page-length="10" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>新闻ID</th>
                                ...
                                <c:forEach items="${newsList}" var="list" varStatus="idx">
                                    <tr>
                                        ...
                                        <td class="col-xs-2" id="news_title_${list.id}"><c:out
                                                value="${list.title}"></c:out></td>
                                        <td class="col-xs-3" id="news_content_${list.id}">${list.content}</td>
                                        <td class="col-xs-2" id="news_imgUrl_${list.id}"><img src="${list.imgUrl}"/>
                                        </td>
                                        <td class="col-xs-1">
                                            <button class="btn btn-info" id="chg_news_${list.id}" data-id="${list.id}"
                                                    btnType="chgButton">修改
                                            </button>
                                            <button class="btn btn-danger" id="del_news_${list.id}" data-id="${list.id}"
                                                    btnType="delButton">删除
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div>
                                ...
                                <c:if test="${prePageIndex != null}">
                                    <a class="btn btn-primary" href="/tanklab/admin/news?page=${prePageIndex}">上页</a>
                                </c:if>
                                <%--遍历列表--%>
                                <c:forEach var="index" begin="1" end="${maxPage}" step="1">
                                    <c:choose>
                                        ...
                                        <c:when test="${page == index}">
                                            <a class="btn btn-info" href="/tanklab/admin/news?page=${index}">${index}</a>
                                        </c:when>
                                        <%--否则正常输出--%>
                                        <c:otherwise>
                                            <a class="btn btn-primary" href="/tanklab/admin/news?page=${index}">${index}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                <%--前一页不为空显示上一页--%>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 <a href="http://www.miitbeian.gov.cn">津ICP备17006007号-1</a>.</strong> All
        rights
        reserved.
    </footer>
    ...
    <div id="add_news_modal" class="row modal fade" role="dialog" aria-labelledby="add_news_modal" aria_hidden="true">
        <div class="box box-primary col-lg-6 col-xs-offset-3" style="width:50%;margin-top:5%;">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="add_news_form" role="form" action="/tanklab/api/v1/news/" method="post"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" rows="10" id="add_content"
                                  placeholder="请输入新闻主要内容"></textarea>
                    </div>
    ...
    <!-- 修改modal框 -->
    <div id="change_news_modal" class="row modal fade" role="dialog" aria-labelledby="change_news_modal"
         aria_hidden="true">
        <div class="box box-primary col-lg-6 col-xs-offset-3" style="width:50%;margin-top:5%;">
            <div class="box-header with-border">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="change_news_form" role="form" action="/tanklab/api/v1/news/change" method="post"
                  enctype="multipart/form-data">
...
<script src="./js_control/news.js"></script>
<script>
    $(function () {
