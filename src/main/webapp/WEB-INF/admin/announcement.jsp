  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active menu-open"><a href="./announcement.jsp"><i class="fa fa-circle-o text-aqua"></i> <span>长期公告管理</span></a></li>
