            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div>
                                <button id="add_announcement" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#add_announcement_modal">添加公告
                                </button>
                            </div>
                            <table id="announcementTable" data-page-length="10"
                                ...
                                <c:forEach items="${announcementList}" var="list" varStatus="idx">
                                    <tr>
                                        ...
                                        <td class="col-xs-1" id="announcement_id_${list.id}"><c:out
                                                value="${list.id}"></c:out></td>
                                        <td class="col-xs-2" id="announcement_date_${list.id}"><c:out
                                                value="${list.date}"></c:out></td>
                                        <td class="col-xs-2" id="announcement_title_${list.id}"><c:out
                                                value="${list.title}"></c:out></td>
                                        <td class="col-xs-3" id="announcement_content_${list.id}">${list.content}</td>
                                        <td class="col-xs-1">
                                            <button class="btn btn-info" id="chg_announcement_${list.id}"
                                                    data-id="${list.id}" btnType="chgButton">修改
                                            </button>
                                            <button class="btn btn-danger" id="del_announcement_${list.id}"
                                                    data-id="${list.id}" btnType="delButton">删除
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div>
                            ...
                            <c:if test="${prePageIndex != null}">
                                <a class="btn btn-primary"
                                   href="/tanklab/admin/announcement?page=${prePageIndex}">上页</a>
                            </c:if>
                            <%--遍历列表--%>
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${page == index}">
                                        <a class="btn btn-info"
                                           href="/tanklab/admin/announcement?page=${index}">${index}</a>
                                    </c:when>
                                    <%--否则正常输出--%>
                                    <c:otherwise>
                                        <a class="btn btn-primary"
                            ...
                            <c:if test="${nextPageIndex != null}">
                                <a class="btn btn-primary"
                                   href="/tanklab/admin/announcement?page=${nextPageIndex}">下页</a>
                            </c:if>
                            <%--page不等于maxPage显示尾页--%>
                            <c:if test="${page != maxPage}">
                                <a class="btn btn-primary" href="/tanklab/admin/announcement?page=${maxPage}">尾页</a>
                            </c:if>
                        </div>
                    </div>
                </div>
...
<div id="add_announcement_modal" class="row modal fade" role="dialog" aria-labelledby="add_announcement_modal"
     aria_hidden="true">
        ...
        <form id="add_announcement_form" role="form" action="/tanklab/api/v1/announcement" method="post">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-control" rows="10" id="add_content"
                              placeholder="请输入公告主要内容"></textarea>
                </div>
                <div class="form-group" style="padding:0px;">
                    ...
                    <div class="form-group">
                        <div class="input-group date">
                            ...
                            <input type="text" name="date" class="form-control pull-right" id="add_date"
...
<!-- 修改modal框 -->
<div id="change_announcement_modal" class="row modal fade" role="dialog" aria-labelledby="change_announcement_modal"
     aria_hidden="true">
    <div class="box box-primary col-lg-6 col-xs-offset-3" style="width:50%;margin-top:5%;">
        <div class="box-header with-border">
        ...
        <form id="change_announcement_form" role="form" action="/tanklab/api/v1/announcement/change" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-control" rows="10" id="change_content"
                              placeholder="请输入公告主要内容"></textarea>
                </div>
                <div class="form-group" style="padding:0px;">
                    ...
                    <div class="form-group">
                        <div class="input-group date">
                            ...
                            <input type="text" name="date" class="form-control pull-right" id="change_date"
                                   data-date-format="yyyy-mm-dd">
                        </div>
                        <!-- /.input group -->
                    </div>
...
<script src="./js_control/announcement.js"></script>
<script>
    $(function () {
