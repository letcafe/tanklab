				...
				if(restMessage.code == 200) {
					...
					for(var i = 0; i < restMessage.data.length; i++) {
						...
						$('#file_form_body').append("<tr>\n" +
                            ...
                            "                  <td class=\"col-xs-2\" id=\"file_path_" + fileObj.id + "\"><a href=\"" + fileObj.path + "\" download=\""+fileObj.fileName+fileObj.path.substring(fileObj.path.lastIndexOf('.'))+"\">" + fileObj.path+" </a></td>\n" +
                            "                  <td class=\"col-xs-1\">\n" +
