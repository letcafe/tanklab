        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form id="loginForm" name="loginForm" action="login" method="post">
                <div class="panel loginbox">
                    <div class="text-center margin-big padding-big-top"><h1>TankLab后台管理中心</h1></div>
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        <div class="form-group">
                            <div class="field field-icon-right">
                                <input type="text" class="input input-big" maxlength='50' id='loginName' name='loginName' value="${loginName}" placeholder="登录账号" />
                    ...
                    <div style="color:#F00;" ><span id="notice" style=" margin-left:10%;">${message}</span></div>
